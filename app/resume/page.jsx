...
const about={
  ...
  info: [
    ...
    {
      fieldName: "Email",
      fieldValue: "abhisheklenovo2001@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const experience={
  ...
  items:[
    {
      company:"Chegg India",
      position:"Calculus Expert(Freelance)",
          ...
          <div className='min-h-[70vh] w-full'>
                  ...
                  <ScrollArea className="h-[400px]">
                    <ul className='grid grid-cols-1 lg:grid-cols-2 gap-[30px]'>
                      {experience.items.map((item,index)=>{
                        return (<li key={index} className='bg-[#232329] h-[184px] py-6 
                      ...
                      <li key={index}>
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className='capitalisze'>{skill.name}</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </li>
            ...
            <TabsContent value="about" className="w-full text-center xl:text-left">
              <div className='flex flex-col gap-[30px]'>
                ...
                <ul className='grid grd-cols-1 xl:grid-cols-2 gap-y-6 max-w-[620px]
                  mx-auto xl:mx-0'>
                  {about.info.map((item, index)=>{
                    return (
                      <li key={index} className='flex items-centerjustify-center xl:justify-start gap-4'>
